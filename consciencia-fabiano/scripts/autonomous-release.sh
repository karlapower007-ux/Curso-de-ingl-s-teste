...
grep -q 'agent_2_engine:"Transformers.js MiniLM q8' public/agent-swarm.js || die "V7_TRANSFORMERS_AGENT_MISSING"
grep -q 'semantic_expansion_used' public/agent-swarm.js || die "V74_SEMANTIC_EXPANSION_MISSING"
grep -q 'semantic-expansion' public/agent-node-worker.js || die "V74_BOUNCER_SEMANTIC_EXPANSION_MISSING"
grep -q 'client_context:analyticClientContext' public/app.js || die "V74_CLIENT_CONTEXT_HANDOFF_MISSING"
