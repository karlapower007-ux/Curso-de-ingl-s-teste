...
assert(app.includes('if (data.full_text) answer = String(data.full_text)'),"stream-full-text");
assert(app.includes('const resposta=String(data.full_text || data.resposta || "")'),"ui-prefers-full-text");
assert(app.includes('event === "section"'),"ui-section-stream");
